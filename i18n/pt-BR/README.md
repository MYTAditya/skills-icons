...
Estamos abertos a contribuições de qualquer pessoa! Se tem interesse em ajudar, por favor siga as regras detalhadas no nosso arquivo [CONTRIBUTING.md](./CONTRIBUTING.md).
...
Para mais instruções sobre como começar, consulte as regras no arquivo [CONTRIBUTING.md](./CONTRIBUTING.md).
...
Este comando mapeia a porta 3000 da sua máquina local para a porta 3000 do container, permitindo-lhe acessar a `Skills Icons` em <http://localhost:3000>.

### Pedidos de Remoção de Ícones 🚫

Empenhamo-nos em respeitar todas as diretrizes de marca e propriedade intelectual. Se você representa uma empresa cujo ícone está incluído neste projeto e gostaria que fosse removido, ou se acredita que utilizamos um ícone de forma que viola as suas diretrizes de marca, por favor abra uma issue neste repositório detalhando o seu pedido. Iremos analisar o seu pedido prontamente e tomar as medidas apropriadas. Agradecemos a sua compreensão e cooperação.
